...
| -------- | -------- | -------- |
| User's meal preferences for each day of the week      | Display prompts for each meal category (breakfast, lunch, dinner, snack) for each day of the week.
Accept user input for each meal category.
Store the user input in appropriate data structures.     | None (void function).     |
